...
bode.addEventListener('mousemove', e => {
        ...
        var y = e.clientY;
        console.log(x + " e " + y );
        gradient="linear-gradient(" + ((((Math.atan2(y-(screen.height/2),x-(screen.width/2))))*360/6.28)+270)+ "deg, rgba(255,255,255,0.19343487394957986) 25%, rgba(0,255,252,0.8715861344537815) 100%)";
